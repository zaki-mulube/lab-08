...
```{r}
#weather %>% count(RainToday == "Yes")
weather_raintoday_true <- filter(weather, RainToday == "Yes")
#View(weather_raintoday_true) delete later
weather_raintoday_true %>% count(Location) %>%
  arrange(desc(n))
```
